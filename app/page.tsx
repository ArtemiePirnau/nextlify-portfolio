...
export default function Home() {
  return (
    <section className="wrapperw-full">
      {/* <div className="info__box flex justify-between mb-60">
        ...
        <nav className="info__menu">
          <ul className="menu__list">
            <li className="menu__item">
              <a className="menu__link" href="https://github.com/ArtemiePirnau">
                <svg
                  fill="#b0b2c3"
      ...
      <div className="about">
        ...
        <p className="about__text"> Let's get acquainted closer</p>
        <div className="about__box">
          <p className="about__box-descr">
            I'm a design-minded, detail oriented software engineer passionate
            about combining beautiful code with beautiful design. I love
            ...
            those who are willing to share their knowledge as much as I want to
